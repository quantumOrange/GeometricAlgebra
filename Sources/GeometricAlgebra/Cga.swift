...
struct CGA  {
    ...
    static var zero:Self {
        CGA(values: Array(repeating: 0, count: 3))
    }
}

extension CGA {
   
    init( value:Float, index:Int) {
        var arr:[Float] = Array(repeating: 0.0, count: 3)
        arr[index] = value
        values = arr
    }
    
    // basis vectors are available
        static var  e1:Self    { CGA(value:1.0,index: 1) }
    static var  e2:Self    { CGA(value:1.0,index: 2) }
    static var  e3:Self    { CGA(value:1.0,index: 3) }
    static var  e4:Self    { CGA(value:1.0,index: 4) }
    static var  e5:Self    { CGA(value:1.0,index: 5) }
    static var  e12:Self    { CGA(value:1.0,index: 6) }
    static var  e13:Self    { CGA(value:1.0,index: 7) }
    static var  e14:Self    { CGA(value:1.0,index: 8) }
    static var  e15:Self    { CGA(value:1.0,index: 9) }
    static var  e23:Self    { CGA(value:1.0,index: 10) }
    static var  e24:Self    { CGA(value:1.0,index: 11) }
    static var  e25:Self    { CGA(value:1.0,index: 12) }
    static var  e34:Self    { CGA(value:1.0,index: 13) }
    static var  e35:Self    { CGA(value:1.0,index: 14) }
    static var  e45:Self    { CGA(value:1.0,index: 15) }
    static var  e123:Self    { CGA(value:1.0,index: 16) }
    static var  e124:Self    { CGA(value:1.0,index: 17) }
    static var  e125:Self    { CGA(value:1.0,index: 18) }
    static var  e134:Self    { CGA(value:1.0,index: 19) }
    static var  e135:Self    { CGA(value:1.0,index: 20) }
    static var  e145:Self    { CGA(value:1.0,index: 21) }
    static var  e234:Self    { CGA(value:1.0,index: 22) }
    static var  e235:Self    { CGA(value:1.0,index: 23) }
    static var  e245:Self    { CGA(value:1.0,index: 24) }
    static var  e345:Self    { CGA(value:1.0,index: 25) }
    static var  e1234:Self    { CGA(value:1.0,index: 26) }
    static var  e1235:Self    { CGA(value:1.0,index: 27) }
    static var  e1245:Self    { CGA(value:1.0,index: 28) }
    static var  e1345:Self    { CGA(value:1.0,index: 29) }
    static var  e2345:Self    { CGA(value:1.0,index: 30) }
    static var  e12345:Self    { CGA(value:1.0,index: 31) }
...
extension CGA {
  ...
  //***********************
      ...
      static prefix func ~ (_ a:CGA) -> CGA {
      var res = CGA.zero
      res[0] = a[0];
  res[1] = a[1];
  res[2] = a[2];
...
//***********************
  ...
  static func * (_ a:CGA, _ b:CGA) -> CGA{
      var res = CGA.zero
...
//***********************
  ...
  static func * (_ a:Float, _ b:CGA) -> CGA{
      var res = CGA.zero
          res[0]  =  a * b[0];
    res[1]  =  a * b[1];
    res[2]  =  a * b[2];
...
//***********************
  ...
  static func * (_ a:CGA, _ b:Float) -> CGA{
      var res = CGA.zero
          res[0]  =  a[0] * b;
    res[1]  =  a[1] * b;
    res[2]  =  a[2] * b;
...
fileprivate func example() {
  /*
    //CGA;
    let px = up(1.0,2.0,3.0);
    //CGA;
    let line = px ^ eo ^ ei;
    CGA; sphere = !(eo-ei);
  print("a point       : "); px.log();
  print("a line        : "); line.log();
  print("a sphere      : "); sphere.log();
*/
}
